...
insert  into `t_users`(`user_ID`,`user_phone_number`,`user_first_name`,`user_last_name`,`user_birth_date`,`user_birth_month`,`user_birth_year`,`user_gender`,`user_email`) values (1,' 6281366393990','Rizka','Utami',26,1,1992,0,'mail@rizkautami.com'),(2,'6281948444180','Faizal','Hasymi',12,4,1991,1,'fhasymi@mail.com');
